...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5" data-aos="fade-up" data-aos-duration="1600">
                    <img src="{{ url('main-assets/images/about-image-1.webp') }}" class="img-fluid" alt=""
                        srcset="" />
                </div>
    ...
    <section class="about-section-2 " style="background-color: #f2f6fb">
        <div class="container">
            <div class="row flex-column-reverse flex-md-row">
                ...
                <div class="col-md-5" data-aos="fade-up" data-aos-duration="1600">
                    <img src="{{ url('main-assets/images/about-image-2.webp') }}" class="img-fluid" alt=""
                        srcset="" />
                </div>
            </div>
        </div>
    ...
    <section class="bonus-section mt-100">
        <div class="container">
            <div class="bg-primary text-white p-5 rounded" data-aos="fade-up" data-aos-duration="1600"
                style="box-shadow:
